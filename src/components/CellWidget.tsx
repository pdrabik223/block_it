...
export const CellWidget: React.FC<CellWidgetProps> = (props: CellWidgetProps) => {
    switch (props.value) {
        case Cell.Blue:
            return <div key={uuidv4()} className='cell_base cell_blue'> </div>
        case Cell.Green:
            return <div key={uuidv4()} className='cell_base cell_green'> </div>
        case Cell.Orange:
            return <div key={uuidv4()} className='cell_base cell_orange'> </div>
        case Cell.Red:
            return <div key={uuidv4()} className='cell_base cell_red'> </div>
        case Cell.Empty:
